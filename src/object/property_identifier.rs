...
generate_custom_enum!(
    /// BACnet property identifiers see BACnetPropertyIdentifier in clause 21.6 of the BACnet specification.
    /// Clause 23.3 of the BACnet specification defines the allowed range for proprietary identifiers.
    PropertyIdentifier {
    AbsenteeLimit = 244,
    AcceptedModes = 175,
